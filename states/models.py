...
class Cities(models.Model):
    ...
    title = models.CharField(max_length=150, null=True, blank=True)
    description = models.TextField(max_length=500, null=True, blank=True , default="Excel in your entrance exams with top-tier coaching in location for Sainik School, RIMC, RMS, Rashtriya Military School, and Military School. Benefit from expert guidance, tailored study plans, and advanced strategies designed for your success. Join us today to secure your future!")
    short_description = models.TextField( null=True, blank=True , default="Premier Coaching for Sainik School, RIMC & RMS in location")
    Image = models.ImageField(upload_to='covers/', blank=True, null=True)
    image_alt = models.CharField( null=True, blank=True , default="Premier Coaching for Sainik School, RIMC & RMS in location")
    meta_keyword = models.TextField(null=True, blank=True ,default="Sainik School coaching location, RIMC coaching classes location, RMS training near me, Rashtriya Military School preparation location, Military School exam coaching location, Sainik School entrance coaching location, RIMC preparation classes, RMS coaching location, top military school coaching, location exam preparation")
    ...
    meta_title = models.CharField(  null=True, blank=True , default="Top Coaching for Sainik School, RIMC & RMS in location")
    meta_description = models.CharField( null=True, blank=True , default="Excel in your entrance exams with top-tier coaching in location for Sainik School, RIMC, RMS, Rashtriya Military School, and Military School. Benefit from expert guidance, tailored study plans, and advanced strategies designed for your success. Join us today to secure your future!")
    latitude   = models.CharField( null=True, blank=True)
    logitude  = models.CharField( null=True, blank=True)
    pincode = models.CharField( null=True, blank=True)
